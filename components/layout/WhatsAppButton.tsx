  ...
  return (
    <div className="fixed bottom-[130px] sm:bottom-6 right-3 sm:right-6 z-40 group flex items-center gap-2">
      <a
        ...
        className="flex items-center gap-2 bg-[#25D366] hover:bg-[#20ba59] active:scale-95 text-white p-3 sm:px-3.5 sm:py-2.5 rounded-full shadow-[0_4px_16px_rgba(37,211,102,0.4)] hover:shadow-[0_6px_22px_rgba(37,211,102,0.5)] transition-all duration-300 transform hover:scale-105"
